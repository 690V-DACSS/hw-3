...
- One plot for a **categorical variable**
- One plot for a **numerical variable**

## Files

- `hw3.qmd` – Quarto source file with code and analysis  
- `hw3.html` – Rendered output with plots  
- `data/` – Dataset used for the assignment
